...
export const ENDPOINTS = {
  ...
  WALLET: {
    ...
    WITHDRAWAL_REQUESTS: '/admin/dashboard/withdrawals',
    AGENCY_PAYOUT_REQUESTS: '/admin/system/payouts',
    ALL: '/admin/system/wallets',
    APPROVE_WITHDRAWAL: (id: string) => `/admin/dashboard/withdrawals/${id}/status`,
    REJECT_WITHDRAWAL: (id: string) => `/admin/dashboard/withdrawals/${id}/status`,
    APPROVE_AGENCY_PAYOUT: (id: string) => `/admin/system/payouts/${id}/approve`,
    REJECT_AGENCY_PAYOUT: (id: string) => `/admin/system/payouts/${id}/reject`,
    FREEZE: (id: string) => `/admin/finance/wallets/${id}/freeze`,
    UNFREEZE: (id: string) => `/admin/finance/wallets/${id}/unfreeze`,
    RECONCILE_BATCH: '/admin/finance/reconcile',
  },
  ROUTING: {
