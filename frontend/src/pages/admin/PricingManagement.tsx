...
const PricingManagement = () => {
  ...
  const scenarios = [
    { label: 'Short', sublabel: '3 km', km: 3, icon: '🏙️', color: 'indigo' },
    { label: 'Medium', sublabel: '12 km', km: 12, icon: '🚚', color: 'violet' },
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px]">
        ...
        <p className="text-sm font-semibold uppercase tracking-widest text-muted-foreground">Loading pricing config...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <PageHeader
        ...
        description="Dynamic configuration of client pricing and partner driver commissions."
        action={
          <Button 
            onClick={handleSave}
            disabled={saving}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className={cn(
          ...
          <div>
            <p className="text-white/80 text-[10px] font-semibold uppercase tracking-wider">Avg Platform Margin</p>
            <p className="text-white text-2xl font-bold tracking-tight">{avgMarginPct.toFixed(1)}%</p>
          </div>
          <p className="text-white/70 text-[10px]">Recommended: 20–35%</p>
        </Card>
        ...
        <Card className="border border-border bg-card shadow-sm p-5 rounded-lg flex flex-col gap-2 relative overflow-hidden">
          ...
          <div>
            <p className="text-muted-foreground text-[10px] font-semibold uppercase tracking-wider">Avg Driver Share</p>
        ...
        <Card className="border border-border bg-card shadow-sm p-5 rounded-lg flex flex-col gap-2 relative overflow-hidden">
          <div className="flex items-center justify-between text-muted-foreground">
            ...
            <span className="text-[10px] font-bold uppercase">Scenario 12 km</span>
          </div>
          <div>
            <p className="text-muted-foreground text-[10px] font-semibold uppercase tracking-wider">Typical Delivery Fee</p>
            <p className="text-foreground text-2xl font-bold tracking-tight">{scenarios[1].price.toFixed(0)} MAD</p>
          </div>
          <p className="text-muted-foreground text-[10px] truncate">Driver: {scenarios[1].driver.toFixed(0)} MAD · Platform: {scenarios[1].margin.toFixed(0)} MAD</p>
        </Card>
        ...
        <Card className="border border-border bg-card shadow-sm p-5 rounded-lg flex flex-col gap-2 relative overflow-hidden">
          <div className="flex items-center justify-between text-muted-foreground">
            ...
            <span className="text-[10px] font-bold uppercase">Cap</span>
          </div>
          <div>
            <p className="text-muted-foreground text-[10px] font-semibold uppercase tracking-wider">Max Client Fee</p>
            <p className="text-foreground text-2xl font-bold tracking-tight">{config.maxDeliveryFee} MAD</p>
          </div>
          <p className="text-muted-foreground text-[10px] truncate">Service: {config.maxServiceDistanceKm} km max · Free: {config.distanceThresholdKm} km</p>
        </Card>
      </div>
      ...
      <Card className="border border-border bg-card shadow-sm rounded-lg p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-foreground">Margin Distribution by Scenario</h4>
            <p className="text-[10px] text-muted-foreground">Standard delivery without extras · Real-time simulation model</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5">
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-[10px] font-semibold">
                  ...
                  <span className={s.marginPct >= 20 && s.marginPct <= 35 ? 'text-primary' : 'text-rose-500'}>
                    Platform: {s.margin.toFixed(2)} MAD ({s.marginPct.toFixed(0)}%)
                  </span>
                </div>
              </div>
              {/* Stacked bar */}
          ...
          <div className="flex flex-wrap items-center gap-6 pt-2 text-[10px] font-medium text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="uppercase tracking-wider">Platform (optimal)</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-sm bg-rose-500" />
              <span className="uppercase tracking-wider">Platform (out of range)</span>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="xl:col-span-8 space-y-8">
          ...
          <Card className="border border-border bg-card shadow-sm p-6 rounded-lg overflow-hidden">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-sm font-semibold uppercase tracking-wider text-foreground">Client Pricing</h3>
                <p className="text-[10px] text-muted-foreground">Tariffs billed to shippers</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="space-y-2">
                <Label className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Base Fee (MAD)</Label>
              ...
              <div className="space-y-2">
                <Label className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Price per KM above threshold (MAD/km)</Label>
                <div className="relative">
            ...
            <div className="mb-6">
              <h4 className="text-[10px] font-bold uppercase tracking-wider text-primary mb-4 flex items-center gap-1.5">
                <Route className="w-3.5 h-3.5" /> Distance Rules
              </h4>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="p-4 rounded-lg bg-muted/30 border border-border space-y-2">
                  ...
                  <p className="text-[8px] text-muted-foreground leading-tight">Distance fee applied after this threshold</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-muted/30 border border-border space-y-2">
                  ...
                  <p className="text-[8px] text-muted-foreground leading-tight">Maximum amount billed to the customer</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-muted/30 border border-border space-y-2">
                  ...
                  <p className="text-[8px] text-muted-foreground leading-tight">Orders rejected beyond this distance</p>
                </div>
              </div>
            </div>
            ...
            <div>
              <h4 className="text-[10px] font-bold uppercase tracking-wider text-primary mb-4 flex items-center gap-1.5">
                <Zap className="w-3.5 h-3.5" /> Optional Surcharges
              </h4>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  { id: 'cod', label: 'COD Handling', icon: DollarSign },
                  { id: 'urgentDeliveryFee', label: 'Urgent Delivery', icon: Clock },
                  { id: 'heavyPackageFee', label: 'Heavy Package', icon: Package },
                ].map((item) => (
          ...
          <Card className="border-none bg-white dark:bg-card shadow-xl p-8 rounded-[2.5rem] overflow-hidden relative">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h3 className="text-xl font-black uppercase tracking-tight">Driver Earnings Model</h3>
                <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Driver compensation</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-6">
                <div className="space-y-3">
                  <Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground ml-1">Calculation Model</Label>
                  <Select 
                  ...
                  >
                    ...
                    <SelectContent className="rounded-2xl">
                      ...
                      <SelectItem value="DISTANCE" className="font-bold">Distance-Based (Distance + Fixed)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className={cn(
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <Label className="text-[10px] font-black uppercase tracking-widest text-emerald-600">Driver Share (%)</Label>
                  ...
                  />
                  <p className="text-[9px] font-bold text-emerald-600/60 uppercase tracking-tight mt-3">The driver receives {Math.round(config.driverPercentage * 100)}% of the total paid by the customer.</p>
                </div>
              </div>
              ...
              <div className={cn(
                ...
                <h4 className="text-[10px] font-black uppercase tracking-widest text-amber-600 flex items-center gap-2">
                  <MapPin className="w-3 h-3" /> Distance Settings
                </h4>
                
                <div className="space-y-2">
                  <Label className="text-[9px] font-black uppercase tracking-widest text-muted-foreground ml-1">Driver Fixed Fee (MAD)</Label>
                  <Input 
                    type="number" 
                    step="0.5"
                ...
                <div className="space-y-2">
                  <Label className="text-[9px] font-black uppercase tracking-widest text-muted-foreground ml-1">Driver KM Rate (MAD/km)</Label>
                  <Input 
                    type="number"
                    step="0.1"
        ...
        <div className="xl:col-span-4 space-y-8">
          ...
          <Card className="border-none bg-slate-900 text-white shadow-2xl p-8 rounded-[2.5rem] relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-black uppercase tracking-tight mb-1">Price Simulator</h3>
              <p className="text-[10px] text-slate-400 font-black uppercase tracking-[0.2em] mb-8">Test live profitability</p>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {[
                    { id: 'cod', label: 'With COD', key: 'cod' as const, fee: config.codHandlingFee },
                    { id: 'urgent', label: 'Urgent', key: 'urgent' as const, fee: config.urgentDeliveryFee },
                    { id: 'heavy', label: 'Heavy Package', key: 'heavy' as const, fee: config.heavyPackageFee },
                  ].map((item) => (
                  ...
                  {simDistanceExceedsMax ? (
                    ...
                    <>
                      ...
                      <div className="space-y-2 text-[10px]">
                        ...
                        <div className="flex justify-between text-slate-400">
                          <span>Distance fee ({Math.max(simDistance - config.distanceThresholdKm, 0).toFixed(1)} km × {config.pricePerKm} MAD)</span>
                        ...
                        {simExtras.urgent && <div className="flex justify-between text-slate-400"><span>Urgency</span><span>+{config.urgentDeliveryFee.toFixed(2)} MAD</span></div>}
                        {simExtras.heavy && <div className="flex justify-between text-slate-400"><span>Heavy package</span><span>+{config.heavyPackageFee.toFixed(2)} MAD</span></div>}
                      ...
                      <div className="flex justify-between items-center p-4 rounded-2xl bg-indigo-500/10 border border-indigo-500/20">
                        <div className="flex flex-col">
                          <span className="text-[9px] uppercase font-black tracking-widest text-indigo-400 mb-1">Platform Margin</span>
                      ...
                      { (marginPercent < 20 || marginPercent > 35) && (
                        <div className="flex gap-2 p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 items-start">
                          ...
                          <p className="text-[9px] font-bold text-amber-500 uppercase leading-tight">Warning: Margin is outside the recommended 20–35%.</p>
                        </div>
                      )}
                    </>
                  )}
          ...
          <Card className="border-none bg-card shadow-xl p-8 rounded-[2.5rem]">
            <h4 className="text-[11px] font-black uppercase tracking-widest text-muted-foreground mb-6 flex items-center gap-2">
              <Info className="w-4 h-4" /> Management Tips
            </h4>
            <div className="space-y-4">
              <div className="flex gap-4 items-start">
                ...
                <p className="text-xs font-bold text-muted-foreground/70 leading-relaxed italic">"The distance model is fairer for drivers in dense urban areas."</p>
              </div>
              <div className="flex gap-4 items-start">
                <div className="w-8 h-8 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0">
                  <CheckCircle2 className="w-4 h-4" />
                </div>
                <p className="text-xs font-bold text-muted-foreground/70 leading-relaxed italic">"Adjust surcharges during high-demand periods to boost your revenue."</p>
              </div>
              <div className="flex gap-4 items-start">
                <div className="w-8 h-8 rounded-lg bg-violet-50 text-violet-600 flex items-center justify-center shrink-0">
                  <CheckCircle2 className="w-4 h-4" />
                </div>
                <p className="text-xs font-bold text-muted-foreground/70 leading-relaxed italic">"Increase the free distance threshold to attract more nearby customers."</p>
              </div>
            </div>
          </Card>
        </div>
