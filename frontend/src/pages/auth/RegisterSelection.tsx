    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-background text-foreground px-4 py-16 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl space-y-10">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-3xl md:text-4xl font-semibold text-foreground tracking-tight">Start Your Journey</h1>
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            <Link to="/login" className="text-primary hover:underline font-semibold ml-1">Sign In Now</Link>
          </p>
        </div>
      </div>
    </div>
